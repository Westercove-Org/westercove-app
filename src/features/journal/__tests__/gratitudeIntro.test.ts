...
const APPROVED_INTRO =
  ...
  'still worth holding — a kindness, a song, an hour of sleep, the fact that they existed at ' +
  'all. Add one if one comes. If nothing comes today, that is an honest answer too.';
