 ...
 * copy, or a category disappears — and only a literal test catches it. The
 * hints below are Wesley's approved wording (spec v7 Item 9; Gratitude added in
 * v16), verbatim, ASCII ellipsis included. If a hint changes, change it here on
 * purpose.
 *
...
describe('approved hints (R-31/R-45)', () => {
  it('the category list is the canonical types', () => {
