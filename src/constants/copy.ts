...
export const copy = {
  ...
  signUpReturn: {
    ...
    slowBody: 'Your payment is still being confirmed. If you paid, you’ll get a verification email shortly — you can safely close this page.',
    errorTitle: 'We hit a snag',
    errorBody: 'We couldn’t confirm your signup. If you completed payment, check your email for a verification link; otherwise please try again.',
