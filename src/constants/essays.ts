/**
 * Essays by Dr. Wesley Carter, shown in Support → Reading → Essays.
 * Copy is verbatim from the reference design and follows the voice rules
 * (no em dashes, "died" not "passed away", no platitudes).
 */
export type Essay = {
  id: string;
  title: string;
